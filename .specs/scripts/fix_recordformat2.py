...
if rf_old:
    rf_new = """<button action="setting 'recordFormat' 'mp3' ? setting 'recordFormat' 'wav' : setting 'recordFormat' 'wav' ? setting 'recordFormat' 'flac' : setting 'recordFormat' 'flac' ? setting 'recordFormat' 'ogg' : setting 'recordFormat' 'ogg' ? setting 'recordFormat' 'mp4' : setting 'recordFormat' 'mp4' ? setting 'recordFormat' 'webm' : setting 'recordFormat' 'mp3'">
			<pos x="1500" y="160"/>
