...
- **Temporary Scripts & Artifacts:** Any ad-hoc scripts (Python, bash, etc.), intermediate files, data dumps, or temporary artifacts generated by the AI MUST be written directly to the `.specs/scripts/` or `.specs/` directory. Never pollute the root directory.
